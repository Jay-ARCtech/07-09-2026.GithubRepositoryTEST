...
export const ENEMY_TYPES = {
  ...
  // -- ranged family: basic (shooter, above), gatling, sniper, launcher --
  gatling: { hp: 18, speed: 70, dmg: 2.2, radius: 13, xp: 6, color: "#fb7185", behavior: "gatling" },
  sniper: { hp: 16, speed: 55, dmg: 17, radius: 13, xp: 8, color: "#facc15", behavior: "sniper" },
  launcher: { hp: 24, speed: 60, dmg: 11, radius: 15, xp: 8, color: "#f97316", behavior: "launcher" },

  // -- support family: healer, summoner, hazard engineer --
  healer: { hp: 22, speed: 95, dmg: 0, radius: 13, xp: 7, color: "#86efac", behavior: "healSupport" },
  summoner: { hp: 26, speed: 65, dmg: 0, radius: 15, xp: 9, color: "#fbbf24", behavior: "summonSupport" },
  engineer: { hp: 22, speed: 78, dmg: 2, radius: 14, xp: 8, color: "#f472b6", behavior: "hazardSupport" },
};
